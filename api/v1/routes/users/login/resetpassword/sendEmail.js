module.exports = (app, utils) => {
    app.post("/api/v1/users/resetpassword/sendEmail", utils.cors(), utils.rateLimiter({
        ...
        <html><body>
        <p style='background-color: #80f41a; color: white; font-size: 48px; font-weight: bold; font-family: "Helvetica Neue", Arial, sans-serif; padding: 60px 10%;' align="center">DinosaurMod Password Reset</p>
            <h1 style='font-family: "Helvetica Neue", Arial, sans-serif;'>Hello ${username}!</h1>
            <p style='font-family: "Helvetica Neue", Arial, sans-serif;'>You are getting this email as someone has asked to reset the password for this DinosaurMod account.</p>
        ...
        const emailPlainText = `DinosaurMod Password Reset
        ...
        ********************
        ...
        password for this DinosaurMod account.
