module.exports = (app, utils) => {
    app.post("/api/v1/users/resetpassword/sendVerifyEmail", utils.cors(), async (req, res) => {
        ...
        <html><body>
        <p style='background-color: #80f41a; color: white; font-size: 48px; font-weight: bold; font-family: "Helvetica Neue", Arial, sans-serif; padding: 60px 10%;' align="center">PenguinMod Email Verification</p>
        ...
        <br>
        <p style='font-family: "Helvetica Neue", Arial, sans-serif;'>If you did not request for this to be a DinosaurMod account's email, you can delete this email or ignore it.</p>
        ...
        <img src="https://dinosaurmod.github.io/favicon.png" alt="DinosaurMod" width="64" height="64" style="width: 64px; height: 64px;">
        </body></html>`;
        const emailPlainText = `DinosaurMod Email Verification
        ...
        ********************
        ...
        this email address as an email for the "${username}" DinosaurMod account.

        Opening the link below will set this as the email address
        for the "${username}" DinosaurMod account.

        Verify this email:
        ${verifyEmailUrl}

        If you did not request for this to be a DinosaurMod account's email,
